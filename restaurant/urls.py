...
from .views import RestaurantAPIView, RatingGenericAPIView,SalesGenericAPIView
urlpatterns = [
    ...
    path('sale/',SalesGenericAPIView.as_view(),name='sale_generic_api_view'),
    path('sale/<int:pk>/',SalesGenericAPIView.as_view(),name='sale_generic_update_delete_retrieve_api_view')
    ]